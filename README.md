...
- [ ] Real-time уведомления через Supabase Realtime (замена polling)
- [ ] WebSocket-канал для совместного редактирования
- [ ] Операции с файлами в фоне (Service Worker / Web Worker)
- [ ] Индикаторы прогресса для всех длительных операций
- [ ] Оптимистичные обновления UI (без перезагрузки)
- [ ] Виртуальный скроллинг для больших списков файлов
- [ ] Ленивая загрузка дерева папок (по раскрытию)
- [ ] Кэширование запросов на клиенте (TTL-based)
